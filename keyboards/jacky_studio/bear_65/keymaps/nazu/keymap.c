...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_wk_bs(
           ...
           KC_PGDN,   HYPR_BS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
                      ...
                      KC_LCTL, KC_LGUI, KC_LALT, LT(_FN1, KC_SPC), KC_R2,                    LT(_FN1, KC_SPC),     KC_R2,   KC_R1,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN1] = LAYOUT_wk_bs(
            ...
            KC_SWAP,  _______, QWERTY,  COLEMAK, CLMKDH,  XXXXXXX, XXXXXXX,             XXXXXXX, KC_HOME, KC_UP,   KC_END,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
           KC_NORM,   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,             XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,          XXXXXXX,
                      _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX,             XXXXXXX, NK_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_VOLU,
