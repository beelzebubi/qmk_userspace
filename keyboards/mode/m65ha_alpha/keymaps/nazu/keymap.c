...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    KC_LCTL,  KC_LGUI, KC_LALT,                           LT(_FN1, KC_SPC),                             KC_RALT,  MO(_FN1), KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
   ...
   */
    ...
    _______,  QWERTY,  COLEMAK, CLMKDH,  XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_UP,   KC_END,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_SWAP,
    _______,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,          XXXXXXX,          KC_NORM,
    _______,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,          KC_VOLU, KC_MPLY,
    _______,  _______,  _______,                                KC_TRNS,                                _______, XXXXXXX, KC_MPRV, KC_VOLD, KC_MNXT
  ),
