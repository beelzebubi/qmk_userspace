...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_65_iso_blocker(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,               LT(_FN1, KC_SPC),              KC_RALT, KC_RCTL,                   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN1] = LAYOUT_65_iso_blocker(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_UP,   KC_END,  KC_TRNS, KC_TRNS, KC_TRNS,          KC_SWAP,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NORM,
